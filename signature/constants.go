...
func (c Constants) GetApiEndpoint() string {
  return api_endpoint
}

func (c Constants) GetApiVersion() string {
  return version
}

func (c Constants) GetExperiments() string {
  return experiments
}

func (c Constants) GetLoginExperiments() string {
  return login_experiments
}

func (c Constants) GetIGCapabilities() string {
  return x_ig_capabilities
}

func (c Constants) GetAndroidVersion() int {
  return android_version
}

func (c Constants) GetAndroidRelease() string {
